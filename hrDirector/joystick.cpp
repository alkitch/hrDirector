...
bool                    CJoystickDevice::g_bFilterOutXinputDevices = false;
XINPUT_DEVICE_NODE*     CJoystickDevice::g_pXInputDeviceList = nullptr;
LPDIRECTINPUT8          CJoystickDevice::g_pDI = nullptr;
LPDIRECTINPUTDEVICE8    CJoystickDevice::g_pJoystick = nullptr;
...
void CJoystickDevice::FreeDirectInput()
{
...
HRESULT CJoystickDevice::InitDirectInput(HWND hWnd)
{
	HRESULT hr;
...
HRESULT CJoystickDevice::UpdateInputState(DIJOYSTATE2& js)
{
	HRESULT hr;  
...
BOOL CALLBACK  CJoystickDevice::EnumJoysticksCallback(const DIDEVICEINSTANCE* pdidInstance,
	VOID* pContext)
{
...
//----------------------------------------------------------------------------- 
BOOL CALLBACK CJoystickDevice::EnumObjectsCallback(const DIDEVICEOBJECTINSTANCE* pdidoi,VOID* pContext)
{
...
//----------------------------------------------------------------------------- 
HRESULT CJoystickDevice::SetupForIsXInputDevice()
{
...
//----------------------------------------------------------------------------- 
bool CJoystickDevice::IsXInputDevice(const GUID* pGuidProductFromDirectInput)
{
...
//----------------------------------------------------------------------------- 
void CJoystickDevice::CleanupForIsXInputDevice()
{
	// Cleanup linked list 
	XINPUT_DEVICE_NODE* pNode = g_pXInputDeviceList;
	while (pNode)
